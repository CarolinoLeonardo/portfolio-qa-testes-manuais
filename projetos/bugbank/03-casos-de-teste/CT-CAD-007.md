...
| 7 | Clicar na opção "Cadastrar" | O sistema não conclui o cadastro, deve exibir a mensagem "Nome não pode ser vazio" e deve permanecer na tela de formulário de cadastro. | O sistema não concluiu o cadastro, exibiu a mensagem "Nome não pode ser vazio" em janela pop-up e permaneceu na tela de formulário de cadastro.  | Aprovado |
