# CT-CAD-005 — Validar a obrigatoriedade do preenchimento do campo Senha para criação de nova conta
...
| 6 | Não preencher o campo "Senha" | O campo obrigatório "Senha" deve permanecer vazio, sem mensagens de validação aparente. | O campo obrigatório "Senha" permaneceu vazio, sem mensagens de validação aparente. | Aprovado |
...
| 8 | Clicar na opção "Cadastrar" | O sistema não conclui o cadastro e deve permanecer na tela de formulário de cadastro. | O sistema não concluiu o cadastro, exibiu a mensagem "É campo obrigatório" embaixo do input da Senha e permaneceu na tela de formulário de cadastro. | Aprovado |
